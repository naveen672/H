...
const KyathanahalliDetail = () => {
  const schoolImages = [
    {
      src: '/IMG-20250910-WA0059.jpg',
      alt: 'T S Subbanna High School Kyathanahalli - Community Event',
      caption: 'Community gathering and school celebration'
    },
    {
      src: '/IMG-20250910-WA0068.jpg',
      alt: 'T S Subbanna High School Kyathanahalli - Student Achievement',
      caption: 'Students celebrating academic achievements with certificates and trophies'
    },
    {
      src: '/IMG-20250910-WA0076.jpg',
      alt: 'T S Subbanna High School Kyathanahalli - Award Distribution',
      caption: 'Award distribution ceremony recognizing student excellence'
    },
    {
      src: '/IMG-20250910-WA0077.jpg',
      alt: 'T S Subbanna High School Kyathanahalli - Student Recognition',
      caption: 'Students with medals and recognition for outstanding performance'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              T S Subbanna High School, Kyathanahalli
            </h1>
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              A distinguished high school providing comprehensive secondary education 
              with emphasis on academic excellence and character development in Kyathanahalli, Mysuru.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Explore our vibrant school life and student achievements
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="prose prose-lg text-gray-600">
                <p className="mb-4">
                  T S Subbanna High School, Kyathanahalli has been serving the educational 
                  needs of the Kyathanahalli community since 1985. Our school is committed 
                ...
                <p className="mb-4">
                  ...
                  faculty and modern facilities ensure that every student receives quality education.
                </p>
                <p>
                  The school emphasizes holistic development, focusing on academic excellence, 
                  character building, and community engagement to prepare well-rounded individuals.
                </p>
              </div>
            </div>
            <div>
              <img 
                src="/IMG-20250910-WA0057.jpg"
      ...
      <section className="py-16 bg-blue-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a 
              href="https://maps.app.goo.gl/gNP4tMFW87VVdZYr6"
              target="_blank"
