...
const AgaraMamballiDetail = () => {
  const schoolImages = [
    {
      src: '/IMG_20250912_202355.jpg',
      alt: 'T S Subbana Smaraka High School Agara Mamballi - Campus View',
      caption: 'School campus and facilities'
    },
    {
      src: '/IMG_20250912_202250.jpg',
      alt: 'T S Subbana Smaraka High School Agara Mamballi - Building View',
      caption: 'Main school building and entrance'
    },
    {
      src: '/_storage_emulated_0_DCIM_Screenshots_IMG_20250912_202239.jpg',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              T S Subbana Smaraka High School, Agara Mamballi
            </h1>
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              A memorial high school serving the Agara Mamballi community, providing quality 
              secondary education with emphasis on rural development and academic excellence.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              ...
              <p className="text-gray-600">Agara Mamballi, Mysuru</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg text-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="prose prose-lg text-gray-600">
                <p className="mb-4">
                  T S Subbana Smaraka High School, Agara Mamballi was established in 2000 
                  as a memorial to honor the legacy of T S Subbanna. Located in the rural 
                  community of Agara Mamballi, our school serves as a beacon of educational 
                  excellence in the region.
                </p>
                <p className="mb-4">
                  We are committed to providing comprehensive secondary education that 
                  prepares students for higher studies while fostering strong community 
                  ties and rural development initiatives. Our curriculum balances academic 
                  rigor with practical life skills.
                </p>
                <p>
                  ...
                  who contribute to both local and global communities.
                </p>
              </div>
            </div>
            <div>
...
export default AgaraMamballiDetail;