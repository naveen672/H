...
const ThayuruDetail = () => {
  ...
  const achievements = [
    ...
    'Rural development and community engagement initiatives'
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              T S Subbanna Sarvajanika High School, Thayuru
            </h1>
            <p className="text-xl text-green-100 max-w-3xl mx-auto">
              A distinguished high school providing comprehensive secondary education with emphasis 
              on academic excellence and community service in the rural area of Thayuru, Mysuru.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              ...
              <h3 className="text-lg font-semibold text-green-800 mb-2">Established</h3>
              <p className="text-gray-600">1995</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              <MapPin className="h-12 w-12 text-green-500 mx-auto mb-4" />
              <h3 className="text-lg font-semibold text-green-800 mb-2">Location</h3>
              <p className="text-gray-600">Thayuru, Mysuru</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              <Users className="h-12 w-12 text-green-500 mx-auto mb-4" />
              <h3 className="text-lg font-semibold text-green-800 mb-2">Students</h3>
              <p className="text-gray-600">450+</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              <BookOpen className="h-12 w-12 text-green-500 mx-auto mb-4" />
              <h3 className="text-lg font-semibold text-green-800 mb-2">Streams</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="prose prose-lg text-gray-600">
                <p className="mb-4">
                  T S Subbanna Sarvajanika High School, Thayuru was established in 1995 
                  to serve the educational needs of the rural Thayuru community. Our school 
                  is committed to providing comprehensive secondary education that prepares 
                  students for higher studies while fostering strong community ties.
                </p>
                <p className="mb-4">
                  ...
                  education in a supportive rural environment.
                </p>
                <p>
                  ...
                  who contribute meaningfully to both rural and urban communities.
                </p>
              </div>
            </div>
            <div>
              <img 
                src="https://images.pexels.com/photos/289740/pexels-photo-289740.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop"
                alt="School campus"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-semibold text-green-800 mb-4 text-center">Science Stream</h3>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-semibold text-green-800 mb-4 text-center">Commerce Stream</h3>
              <p className="text-gray-600 text-center mb-4">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-semibold text-green-800 mb-4 text-center">Arts Stream</h3>
              <p className="text-gray-600 text-center mb-4">
              ...
              <div className="space-y-4">
                {achievements.map((achievement, index) => (
                  <div key={index} className="flex items-start space-x-3">
                    <Trophy className="h-6 w-6 text-green-500 flex-shrink-0 mt-0.5" />
      ...
      <section className="py-16 bg-green-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              to="/contact"
              className="bg-amber-500 text-green-900 px-8 py-3 rounded-lg font-semibold hover:bg-amber-400 transition-colors duration-200"
            >
              Contact for Admissions
            </Link>
            <a 
              href="https://maps.app.goo.gl/XsCEw6uU9XFpxNBY6"
              target="_blank"
